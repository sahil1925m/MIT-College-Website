    ...
    return (
        <div className="page-wrapper" style={{ paddingTop: '80px' }}>
            ...
            <div style={{ background: 'var(--navy)', color: '#fff', padding: '6rem 5% 4rem', textAlign: 'center' }}>
                <h1 className="section-title section-title-white" style={{ fontSize: '3.5rem', marginBottom: '1rem' }}>About <span>Us</span></h1>
            ...
            {/* Vision & Mission */}
            <div className="container" style={{ maxWidth: '1000px', margin: '4rem auto', padding: '0 5%', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem' }}>
                <div style={{ background: '#fff', padding: '2.5rem', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.05)' }}>
