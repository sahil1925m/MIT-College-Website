...
export const departments: Department[] = [
  ...
  },
  {
    ...
    faculties: [
      { name: 'Mr. Vijay Kumar Malviya', role: 'Assistant Professor & HOD', experience: '—', qualification: '—', research: '—', isHOD: true },
      { name: 'Ms Shilpa Raghuvanshi', role: 'Assistant Professor', experience: '10 Years', qualification: 'MTech', research: 'Network Security' },
      { name: 'Mr Abhishek Pipliya', role: 'Assistant Professor', experience: '15 years', qualification: 'PhD CS (Pursuing), MTech CS, BE IT', research: 'Machine Learning, Image Processing' },
      { name: 'Ms Bhanupriya Vyas', role: 'Assistant Professor', experience: '9 years', qualification: 'MTech CSE', research: 'Data Science, Machine Learning' },
      { name: 'Ms Abhilasha Vyas', role: 'Assistant Professor', experience: '10 years', qualification: 'MTech', research: 'Data Mining' },
    ],
  },
  {
    id: 'aiml',
    ...
    hodName: 'Mr. Pratyush Sharma',
    hodDesk: `The department has the vision to develop creative software and hardware engineers, who can lead our nation to international recognition and market place. The curriculum for AI/ML is primarily designed to provide students with both the theoretical knowledge and technical skills. It enables the aspirants to solve various complex problems and develops expertise in Artificial Intelligence, Machine Learning, Deep Learning, and related cutting-edge technologies that are transforming industries worldwide.`,
    ...
    faculties: [
      ...
      { name: 'Ms Shruti Lakhotiya', role: 'Assistant Professor', experience: '4 years', qualification: 'MTech', research: 'Cloud Computing' },
      { name: 'Ms Poonam Chourasiya', role: 'Assistant Professor', experience: '5 years', qualification: 'MTech', research: 'Cloud Computing' },
      { name: 'Ms Praneeta Bisen', role: 'Assistant Professor', experience: '4 years', qualification: 'MTech', research: 'Data Analytics' },
      { name: 'Mr Raghvendra Prasad', role: 'Assistant Professor', experience: '12 years', qualification: 'MTech', research: 'Machine Learning' },
    ],
  },
  {
  ...
  },
  {
    ...
    faculties: [
      { name: 'Mr Pushpendra Agrawal', role: 'Assistant Professor & HOD', experience: '—', qualification: '—', research: '—', isHOD: true },
      { name: 'Mr Dheeraj Mandliya', role: 'Assistant Professor', experience: '6 Years', qualification: 'M.E.(Machine Design)', research: 'Advanced Production, Machine design' },
      { name: 'Mr Pushpendra Mishra', role: 'Assistant Professor', experience: '14 years', qualification: 'M.Tech (Machine Design)', research: 'Battery Thermal Management System, Gear Design' },
      { name: 'Mr Dilip Gehlot', role: 'Assistant Professor', experience: '15 years', qualification: 'M.Tech (Thermal Engineering)', research: 'Heat & Mass Transfer, I.C.Engine, Renewable energy' },
      { name: 'Mr Sunil Meshram', role: 'Assistant Professor', experience: '4 Years', qualification: 'M.E.(Tribology & Maintenance)', research: 'Noise & Acoustic Emission, Diagnostic Maintenance' },
    ],
  },
  {
    id: 'ce',
  ...
  },
  {
    ...
    faculties: [
      { name: 'Dr. Kranti Pandey', role: 'HOD MBA Department', experience: '—', qualification: 'PhD', research: 'Business Management', isHOD: true },
      { name: 'Mr Priyank Shinde', role: 'Assistant Professor', experience: '7 years', qualification: 'MBA in Foreign Trade', research: 'International Marketing, HR, Training and Development' },
      { name: 'Ms Madhuri Kriplani', role: 'Assistant Professor', experience: '7 years', qualification: 'M.B.A.', research: 'Business Management' },
      { name: 'Mr Himanshu Matre', role: 'Assistant Professor', experience: '6 years', qualification: 'BE (Info Tech), MBA (Marketing & Finance)', research: 'Marketing Management' },
    ],
  },
];
